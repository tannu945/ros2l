...
class Metaclass_CountUntil_Goal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('action_2_tutorials')
        except ImportError:
            import logging
            import traceback
...
class CountUntil_Goal(metaclass=Metaclass_CountUntil_Goal):
    ...
    def __init__(self, **kwargs):
        ...
        self.max_number = kwargs.get('max_number', int())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.max_number != other.max_number:
            return False
    ...
    def max_number(self, value):
        if __debug__:
            assert \
                ...
                "The 'max_number' field must be of type 'int'"
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'max_number' field must be an integer in [-9223372036854775808, 9223372036854775807]"
...
class CountUntil_Feedback(metaclass=Metaclass_CountUntil_Feedback):
    ...
    def percentage(self, value):
        if __debug__:
            ...
            assert value >= -1.7976931348623157e+308 and value <= 1.7976931348623157e+308, \
                "The 'percentage' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
...
class CountUntil_SendGoal_Request(metaclass=Metaclass_CountUntil_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'action_2_tutorials/CountUntil_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['action_2_tutorials', 'action'], 'CountUntil_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from action_2_tutorials.action._count_until import CountUntil_Goal
...
class Metaclass_CountUntil_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'action_2_tutorials.action.CountUntil_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from action_2_tutorials.action import _count_until
...
class CountUntil_SendGoal(metaclass=Metaclass_CountUntil_SendGoal):
    from action_2_tutorials.action._count_until import CountUntil_SendGoal_Request as Request
    from action_2_tutorials.action._count_until import CountUntil_SendGoal_Response as Response
...
class CountUntil_GetResult_Response(metaclass=Metaclass_CountUntil_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'action_2_tutorials/CountUntil_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['action_2_tutorials', 'action'], 'CountUntil_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from action_2_tutorials.action._count_until import CountUntil_Result
...
class Metaclass_CountUntil_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'action_2_tutorials.action.CountUntil_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class CountUntil_GetResult(metaclass=Metaclass_CountUntil_GetResult):
    from action_2_tutorials.action._count_until import CountUntil_GetResult_Request as Request
    from action_2_tutorials.action._count_until import CountUntil_GetResult_Response as Response
...
class Metaclass_CountUntil_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'action_2_tutorials.action.CountUntil_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class CountUntil_FeedbackMessage(metaclass=Metaclass_CountUntil_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'action_2_tutorials/CountUntil_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['action_2_tutorials', 'action'], 'CountUntil_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from action_2_tutorials.action._count_until import CountUntil_Feedback
...
class Metaclass_CountUntil(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'action_2_tutorials.action.CountUntil')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class CountUntil(metaclass=Metaclass_CountUntil):
    ...
    from action_2_tutorials.action._count_until import CountUntil_Goal as Goal
    # The result message defined in the action definition.
    from action_2_tutorials.action._count_until import CountUntil_Result as Result
    # The feedback message defined in the action definition.
    from action_2_tutorials.action._count_until import CountUntil_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from action_2_tutorials.action._count_until import CountUntil_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from action_2_tutorials.action._count_until import CountUntil_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from action_2_tutorials.action._count_until import CountUntil_FeedbackMessage as FeedbackMessage
