...
[[deprecated("use action_tutorials::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const action_tutorials::action::Fibonacci_Goal & msg,
  std::ostream & out, size_t indentation = 0)
{
  action_tutorials::action::to_block_style_yaml(msg, out, indentation);
}

[[deprecated("use action_tutorials::action::to_yaml() instead")]]
inline std::string to_yaml(const action_tutorials::action::Fibonacci_Goal & msg)
{
  return action_tutorials::action::to_yaml(msg);
}
...
template<>
inline const char * name<action_tutorials::action::Fibonacci_Goal>()
{
  return "action_tutorials/action/Fibonacci_Goal";
}
...
[[deprecated("use action_tutorials::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const action_tutorials::action::Fibonacci_Result & msg,
  std::ostream & out, size_t indentation = 0)
{
  action_tutorials::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use action_tutorials::action::to_yaml() instead")]]
inline std::string to_yaml(const action_tutorials::action::Fibonacci_Result & msg)
{
  return action_tutorials::action::to_yaml(msg);
}
...
template<>
inline const char * name<action_tutorials::action::Fibonacci_Result>()
{
  return "action_tutorials/action/Fibonacci_Result";
}
...
[[deprecated("use action_tutorials::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const action_tutorials::action::Fibonacci_Feedback & msg,
  std::ostream & out, size_t indentation = 0)
{
  action_tutorials::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use action_tutorials::action::to_yaml() instead")]]
inline std::string to_yaml(const action_tutorials::action::Fibonacci_Feedback & msg)
{
  return action_tutorials::action::to_yaml(msg);
}
...
template<>
inline const char * name<action_tutorials::action::Fibonacci_Feedback>()
{
  return "action_tutorials/action/Fibonacci_Feedback";
}
...
[[deprecated("use action_tutorials::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const action_tutorials::action::Fibonacci_SendGoal_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
  action_tutorials::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use action_tutorials::action::to_yaml() instead")]]
inline std::string to_yaml(const action_tutorials::action::Fibonacci_SendGoal_Request & msg)
{
  return action_tutorials::action::to_yaml(msg);
}
...
template<>
inline const char * name<action_tutorials::action::Fibonacci_SendGoal_Request>()
{
  return "action_tutorials/action/Fibonacci_SendGoal_Request";
}
...
[[deprecated("use action_tutorials::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const action_tutorials::action::Fibonacci_SendGoal_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  action_tutorials::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use action_tutorials::action::to_yaml() instead")]]
inline std::string to_yaml(const action_tutorials::action::Fibonacci_SendGoal_Response & msg)
{
  return action_tutorials::action::to_yaml(msg);
}
...
template<>
inline const char * name<action_tutorials::action::Fibonacci_SendGoal_Response>()
{
  return "action_tutorials/action/Fibonacci_SendGoal_Response";
}
...
template<>
inline const char * name<action_tutorials::action::Fibonacci_SendGoal>()
{
  return "action_tutorials/action/Fibonacci_SendGoal";
}
...
[[deprecated("use action_tutorials::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const action_tutorials::action::Fibonacci_GetResult_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
  action_tutorials::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use action_tutorials::action::to_yaml() instead")]]
inline std::string to_yaml(const action_tutorials::action::Fibonacci_GetResult_Request & msg)
{
  return action_tutorials::action::to_yaml(msg);
}
...
template<>
inline const char * name<action_tutorials::action::Fibonacci_GetResult_Request>()
{
  return "action_tutorials/action/Fibonacci_GetResult_Request";
}
...
[[deprecated("use action_tutorials::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const action_tutorials::action::Fibonacci_GetResult_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  action_tutorials::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use action_tutorials::action::to_yaml() instead")]]
inline std::string to_yaml(const action_tutorials::action::Fibonacci_GetResult_Response & msg)
{
  return action_tutorials::action::to_yaml(msg);
}
...
template<>
inline const char * name<action_tutorials::action::Fibonacci_GetResult_Response>()
{
  return "action_tutorials/action/Fibonacci_GetResult_Response";
}
...
template<>
inline const char * name<action_tutorials::action::Fibonacci_GetResult>()
{
  return "action_tutorials/action/Fibonacci_GetResult";
}
...
[[deprecated("use action_tutorials::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const action_tutorials::action::Fibonacci_FeedbackMessage & msg,
  std::ostream & out, size_t indentation = 0)
{
  action_tutorials::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use action_tutorials::action::to_yaml() instead")]]
inline std::string to_yaml(const action_tutorials::action::Fibonacci_FeedbackMessage & msg)
{
  return action_tutorials::action::to_yaml(msg);
}
...
template<>
inline const char * name<action_tutorials::action::Fibonacci_FeedbackMessage>()
{
  return "action_tutorials/action/Fibonacci_FeedbackMessage";
}
